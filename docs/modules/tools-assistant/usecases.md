# AI Assistant Tools Use Cases

### Local developer conversion

| Aspect | Detail |
|--------|--------|
| Objective | Convert a single Skill bundles and prompts during feature work. |
| Input | Sample Skill bundles and prompts |
| Output | Assembled context and assistant output |
| Configuration | `pip install -e ".[skill-openai]"` |
...
| Input | Assembled context and assistant output |
