# AI Assistant Tools Troubleshooting

| Symptom | Likely cause | Fix |
|---------|--------------|-----|
| `command not found` | Extra not installed / venv inactive | `pip install -e ".[skill-openai]"` |
...
python -c "import md_generator.tools.assistant; print('ok')"
```
