...
| Aspect | Detail |
|--------|--------|
| Objective | Convert a single Image files or directories during feature work. |
| Input | Sample Image files or directories |
| Output | OCR Markdown and metadata |
| Configuration | `pip install -e ".[image]"` |
...
| Input | OCR Markdown and metadata |
