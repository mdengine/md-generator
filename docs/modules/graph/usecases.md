# Graph Metadata Use Cases

### Local developer conversion

| Aspect | Detail |
|--------|--------|
| Objective | Convert a single Neo4j or NetworkX GraphML/GML during feature work. |
| Input | Sample Neo4j or NetworkX GraphML/GML |
| Output | Node/relationship Markdown, Mermaid, Graphviz |
| Configuration | `pip install -e ".[graph]"` |
...
| Input | Node/relationship Markdown, Mermaid, Graphviz |
