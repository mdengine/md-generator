# URL and Web Architecture

## Internal layout

Source root: `src/md_generator/url` (20 Python modules detected).
...
```mermaid
flowchart TB
    CLI[CLI_md-url] --> Core[Core_engine]
...
- **Inputs:** HTTP(S) pages
- **Outputs:** Cleaned Markdown and optional artifacts
- **Optional extras:** `url or url-full` from `pyproject.toml`
