# URL and Web Use Cases

### Local developer conversion

| Aspect | Detail |
|--------|--------|
| Objective | Convert a single HTTP(S) pages during feature work. |
| Input | Sample HTTP(S) pages |
| Output | Cleaned Markdown and optional artifacts |
| Configuration | `pip install -e ".[url]"` |
...
| Input | Cleaned Markdown and optional artifacts |
