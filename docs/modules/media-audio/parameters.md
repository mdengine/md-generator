...
| Name | Type | Required | Default | Choices | Description |
| --- | --- | --- | --- | --- | --- |
| AUDIO_TO_MD_PORT | string/int | optional | varies | — | HTTP API listen port |
...
- Missing optional dependencies raise install-time or runtime errors referencing the PyPI extra `audio`.
