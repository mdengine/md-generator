...
Source root: `src/md_generator/media/audio` (10 Python modules detected).
...
```mermaid
flowchart TB
    CLI[CLI_md-audio] --> Core[Core_engine]
...
- **Inputs:** Audio files
- **Outputs:** Whisper transcript Markdown
- **Optional extras:** `audio` from `pyproject.toml`
