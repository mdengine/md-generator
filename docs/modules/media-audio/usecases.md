...
| Aspect | Detail |
|--------|--------|
| Objective | Convert a single Audio files during feature work. |
| Input | Sample Audio files |
| Output | Whisper transcript Markdown |
| Configuration | `pip install -e ".[audio]"` |
...
| Input | Whisper transcript Markdown |
