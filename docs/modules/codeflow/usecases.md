...
| Aspect | Detail |
|--------|--------|
| Objective | Convert a single Source repositories during feature work. |
| Input | Sample Source repositories |
| Output | Architecture Markdown, graphs, flow docs, JSON, Mermaid |
| Configuration | `pip install -e ".[codeflow]"` |
...
| Input | Architecture Markdown, graphs, flow docs, JSON, Mermaid |
