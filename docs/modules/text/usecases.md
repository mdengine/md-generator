# Text JSON XML Use Cases

### Local developer conversion

| Aspect | Detail |
|--------|--------|
| Objective | Convert a single TXT, JSON, XML during feature work. |
| Input | Sample TXT, JSON, XML |
| Output | Readable Markdown representations |
| Configuration | `pip install -e ".[text]"` |
...
| Input | Readable Markdown representations |
