# Text JSON XML Architecture

## Internal layout

Source root: `src/md_generator/text` (18 Python modules detected).
...
```mermaid
flowchart TB
    CLI[CLI_md-text] --> Core[Core_engine]
...
- **Inputs:** TXT, JSON, XML
- **Outputs:** Readable Markdown representations
- **Optional extras:** `text` from `pyproject.toml`
