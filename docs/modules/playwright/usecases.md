# Playwright Web Capture Use Cases

### Local developer conversion

| Aspect | Detail |
|--------|--------|
| Objective | Convert a single Rendered web pages and SPAs during feature work. |
| Input | Sample Rendered web pages and SPAs |
| Output | Browser-captured Markdown |
| Configuration | `pip install -e ".[playwright]"` |
...
| Input | Browser-captured Markdown |
