# Playwright Web Capture Troubleshooting

| Symptom | Likely cause | Fix |
|---------|--------------|-----|
| `command not found` | Extra not installed / venv inactive | `pip install -e ".[playwright]"` |
...
```bash
md-playwright --help
python -c "import md_generator.playwright; print('ok')"
```
