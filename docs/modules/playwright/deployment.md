...
Install extras in container image; invoke `md-playwright` as Job/Cron.

## Docker API

If `playwright-to-md/Dockerfile.api` exists, build and run uvicorn with `--root-path /playwright-to-md` behind gateway (`deploy/docker-compose.yml`).
