# Playwright Web Capture Architecture

## Internal layout

Source root: `src/md_generator/playwright` (17 Python modules detected).
...
```mermaid
flowchart TB
    CLI[CLI_md-playwright] --> Core[Core_engine]
...
- **Inputs:** Rendered web pages and SPAs
- **Outputs:** Browser-captured Markdown
- **Optional extras:** `playwright` from `pyproject.toml`
