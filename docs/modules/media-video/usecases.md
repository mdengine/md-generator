...
| Aspect | Detail |
|--------|--------|
| Objective | Convert a single Video files during feature work. |
| Input | Sample Video files |
| Output | Transcript Markdown with video metadata |
| Configuration | `pip install -e ".[video]"` |
...
| Input | Transcript Markdown with video metadata |
