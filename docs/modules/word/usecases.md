...
| Aspect | Detail |
|--------|--------|
| Objective | Convert a single DOCX documents during feature work. |
| Input | Sample DOCX documents |
| Output | Markdown with optional embedded images |
| Configuration | `pip install -e ".[word]"` |
...
| Input | Markdown with optional embedded images |
