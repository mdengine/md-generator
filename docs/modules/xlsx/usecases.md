# Excel and CSV Use Cases

### Local developer conversion

| Aspect | Detail |
|--------|--------|
| Objective | Convert a single XLSX, XLSM, CSV during feature work. |
| Input | Sample XLSX, XLSM, CSV |
| Output | Worksheet or CSV Markdown tables |
| Configuration | `pip install -e ".[xlsx]"` |
...
| Input | Worksheet or CSV Markdown tables |
