...
1. Install `mdengine[xlsx]`.
2. Run `md-xlsx --help` to list flags.
3. Provide input (XLSX, XLSM, CSV) and output path.
4. Inspect generated Markdown and sidecar assets.

## API workflow

1. Install `mdengine[xlsx,api]`.
2. Start uvicorn on `md_generator.xlsx` API module (see Deployment).
