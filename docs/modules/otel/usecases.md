# OpenTelemetry Traces Use Cases

### Local developer conversion

| Aspect | Detail |
|--------|--------|
| Objective | Convert a single OTLP JSON or protobuf trace exports during feature work. |
| Input | Sample OTLP JSON or protobuf trace exports |
| Output | Trace summary Markdown (`trace.md`) |
| Configuration | `pip install -e ".[log-otel-proto]"` |
...
| Input | Trace summary Markdown (`trace.md`) |
