...
Service title: **openapi-to-md**  
Source: `src\md_generator\openapi\api\main.py`
...
| POST | /openapi-to-md/generate | See OpenAPI `/docs` | Upload/body per route | Job id or ZIP | Standard FastAPI errors |
