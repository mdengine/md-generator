...
Install extras in container image; invoke `md-log` as Job/Cron.

## Docker API

If `log-to-md/Dockerfile.api` exists, build and run uvicorn with `--root-path /log-to-md` behind gateway (`deploy/docker-compose.yml`).
