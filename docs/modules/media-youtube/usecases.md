...
| Aspect | Detail |
|--------|--------|
| Objective | Convert a single YouTube URLs during feature work. |
| Input | Sample YouTube URLs |
| Output | Transcript and metadata Markdown |
| Configuration | `pip install -e ".[youtube]"` |
...
| Input | Transcript and metadata Markdown |
