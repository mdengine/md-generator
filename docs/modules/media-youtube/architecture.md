...
Source root: `src/md_generator/media/youtube` (12 Python modules detected).
...
```mermaid
flowchart TB
    CLI[CLI_md-youtube] --> Core[Core_engine]
...
- **Inputs:** YouTube URLs
- **Outputs:** Transcript and metadata Markdown
- **Optional extras:** `youtube` from `pyproject.toml`
