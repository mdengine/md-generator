...
Install extras in container image; invoke `md-ppt` as Job/Cron.

## Docker API

If `ppt-to-md/Dockerfile.api` exists, build and run uvicorn with `--root-path /ppt-to-md` behind gateway (`deploy/docker-compose.yml`).
