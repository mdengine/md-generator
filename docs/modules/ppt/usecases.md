...
| Aspect | Detail |
|--------|--------|
| Objective | Convert a single PPTX slide decks during feature work. |
| Input | Sample PPTX slide decks |
| Output | Slide Markdown and extracted assets |
| Configuration | `pip install -e ".[ppt]"` |
...
| Input | Slide Markdown and extracted assets |
