...
Source root: `src/md_generator/ppt` (21 Python modules detected).

Subpackages and areas: `api`, `vendor_pdf_md`, `vendor_word_md`.

## Component diagram

```mermaid
flowchart TB
    CLI[CLI_md-ppt] --> Core[Core_engine]
...
- **Inputs:** PPTX slide decks
- **Outputs:** Slide Markdown and extracted assets
- **Optional extras:** `ppt` from `pyproject.toml`
