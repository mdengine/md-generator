...
| Aspect | Detail |
|--------|--------|
| Objective | Convert a single PDF documents during feature work. |
| Input | Sample PDF documents |
| Output | Markdown with optional artifact layout and extracted images |
| Configuration | `pip install -e ".[pdf]"` |
...
| Input | Markdown with optional artifact layout and extracted images |
