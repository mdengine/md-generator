...
Install extras in container image; invoke `md-pdf` as Job/Cron.

## Docker API

If `pdf-to-md/Dockerfile.api` exists, build and run uvicorn with `--root-path /pdf-to-md` behind gateway (`deploy/docker-compose.yml`).
