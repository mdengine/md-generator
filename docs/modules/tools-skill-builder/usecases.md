# Skill Builder Use Cases

### Local developer conversion

| Aspect | Detail |
|--------|--------|
| Objective | Convert a single Project metadata during feature work. |
| Input | Sample Project metadata |
| Output | Structured skills under ai/ |
| Configuration | `pip install -e ".[(base]"` |
...
| Input | Structured skills under ai/ |
