"""Tree-sitter Zig → IRMethod (minimal)."""
...
from md_generator.codeflow.parsers.treesitter_zig_parser import zig_language


def populate_ir_methods_zig_treesitter(fr: FileParseResult, project_root: Path) -> None:
