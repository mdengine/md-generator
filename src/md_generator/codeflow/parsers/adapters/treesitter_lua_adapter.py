"""Tree-sitter Lua → IRMethod (minimal)."""
...
from md_generator.codeflow.parsers.treesitter_lua_parser import lua_language


def populate_ir_methods_lua_treesitter(fr: FileParseResult, project_root: Path) -> None:
