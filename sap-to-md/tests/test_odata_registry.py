...
from md_generator.sap.models.metadata.odata import ODataFormat, ODataVersion
from md_generator.sap.parser.odata.detector import detect_format, detect_version
from md_generator.sap.parser.odata.registry import get_parser, parse_document
